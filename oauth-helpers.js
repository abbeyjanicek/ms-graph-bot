...
class OAuthHelpers {
     ...
     */
    static async createEvent(turnContext, tokenResponse, emailAddress) {
        if (!turnContext) {
        ...
        await turnContext.sendActivity(
            `Success! I have scheduled a meeting with you and ${emailAddress
            } have created an event on each of their calendars.`);
    }
